...
def main():
    try:
        ...
        collection.add(
            ...
            # Adding metadata for filtering and search
            metadatas=[{
                "name": employee["name"],
        ...
        collection.update(
            ids=["employee_20"],
            documents=["Updated document for John Doe: Software Engineer with 5 years of experience in Engineering. Skills: Python, JavaScript, React, Node.js, databases. Located in New York. Employment type: Full-time."],
            metadatas=[{
                "name": "John Doe 123",
                "department": "Engineering",
                "role": "Software Engineer",
        ...
        def perform_advanced_search(collection, all_items):
            try:
                ...
                query_text = "team leader manager with experience"2
                results = collection.query(
                    query_texts=[query_text],
                    n_results=3
                )
