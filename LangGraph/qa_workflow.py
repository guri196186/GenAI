...
qa_workflow.add_edge("ContextNode", END)
qa_app = qa_workflow.compile()

result = qa_app.invoke({"question": "What is the weather today?"})
print(result)
result = qa_app.invoke({"question": "What is LangGraph?"})
print(result)
result = qa_app.invoke({"question": "What is the best guided project?"})
print(result)